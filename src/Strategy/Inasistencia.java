 ...
 * @author JuanPablo
 */
public class Inasistencia implements Sancion{
    ...
    public void sancionar() {
        ...
        //int fila1 = CrearPartidos.equipoUno.getSelectedRow();
        //String valor1 = String.valueOf(CrearPartidos.equipoUno.getValueAt(fila1, 0));
        ...
        String SQL2 = "UPDATE jugadores SET tiempoSancion= '3 partidos' WHERE idjugadores=" + valor + "";  
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Sancionado por inasistencia al partido");
        } catch (Exception e) {
